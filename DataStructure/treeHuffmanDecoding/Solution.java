package DataStructure.treeHuffmanDecoding;
...
class Decoding {
    ...
    void generateMap() {
        Map<Character, String> solutionMap = Solution.mapA;
    ...
    void generateMap(Node node, StringBuilder builder) {
        ...
        builder.append('0');
        generateMap(node.left, builder);
        builder.deleteCharAt(builder.length() - 1);

        builder.append('1');
        generateMap(node.right, builder);
        builder.deleteCharAt(builder.length() - 1);
    }

    void decode(String s, Node root) {
        generateMap(root, new StringBuilder());
